...
import ShadowBg from "../src/img/shadow3.jpg";
  ...
  return (
    <div style={{ fontFamily: "Poppins" }} className="leading-[33px]">
          ...
          <div className="flex justify-between items-center mb-10">
            ...
            <div className="hidden md:block">
              <ul className="flex justify-between items-center">
                ...
                <li className="px-5 lg:px-[60px] text-lg lg:text-xl  font-regular leading-[39px] w-[135px]h-[40px]  lg:h-[50px] bg-black rounded-xl text-white  flex justify-center items-center">
                  <a href="#">Register</a>
                </li>
              </ul>
            </div>
            ...
            {open && (
              <div
                className={`block md:hidden absolute   top-20 bg-black  inset-x-0 py-6 ${
                  open && "transition delay-700 z-[999]"
                }`}
              >
      ...
      <div className="relative px-[20px] md:px-[50px] lg:px-[90px]">
        <div className="mb-[260px] relative z-50">
          <div className="block md:flex justify-between">
            <div className="col-span-5 relative md:col-span-2 p-4 flex flex-col  justify-center gap-20">
              <div className="flex flex-col gap-4">
                ...
                <h1 className="text-xl md:text-4xl lg:text-[64px] font-bold leading-5 lg:leading-[75px]  bg-gradient-to-r from-[#7920E8] via-[#CB26B6] to-[#dd3131] bg-clip-text text-transparent relative z-10">
                  SOCIAL MEDIA
                </h1>{" "}
                <h3 className="text-xl md:text-4xl font-bold leading-5 lg:leading-[75px]">
                  Presence…
              ...
              <p className="lg:text-xl font-regular w-auto md:w-64 lg:w-[548px]">
            ...
            <div className="col-span-5 md:col-span-3 relative mt-5 md:mt-0 flex justify-start">
              <img
              ...
              />
              {/* box  */}
              <div className=" backdrop-blur-lg shadow-[0_9px_30px_rgb(0,0,0,0.12)] absolute top-14 lg:left-[25%] w-auto lg:w-[80%]  md:left-1/4 rounded-2xl border-4 border-[#FDFDFD] lg:w-[435px]">
                      ...
                      >
                        <div className="flex items-center gap-3 md:gap-9">
                          <img
                            ...
                            alt=""
                          />
                          <h2 className="text-[17px] font-regular">
                            {" "}
                            Instagram
                          </h2>
                        </div>
                      ...
                      >
                        <div className="flex items-center gap-3 md:gap-9">
                          <img
                            ...
                            alt=""
                          />
                          <h2 className="text-[17px] font-regular"> Tiktok</h2>
                        </div>
                        <div>
                          <img src={Arrow} alt="" />
                        </div>
                      ...
                      >
                        <div className="flex items-center gap-3 md:gap-9">
                          <img
                            ...
                            alt=""
                          />
                          <h2 className="text-[17px] font-regular"> Youtube</h2>
                        </div>
                        <div>
                          <img src={Arrow} alt="" />
                        </div>
              ...
              <div className="absolute hidden lg:block lg:top-0 left-20 md:left-4 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] p-3 rounded-2xl">
                <div className="flex justify-center gap-3 items-center w-[179px]">
                  <img className="w-[26px] h-[21px]" src={Love} alt="" />
                  <span>Marketing</span>
                </div>
              </div>
              <div className="absolute hidden lg:block right-7 md:top-10 lg:top-0 md:right-10 lg:right-12 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] p-3 rounded-2xl">
                <div className="flex justify-center gap-3 items-center w-[179px]">
      ...
      <div className="relative px-[20px] md:px-[50px] lg:px-[90px]">
        ...
        <div className="px-[20px] md:px-[50px] lg:px-[90px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[100px] mb-44 relative z-30  text-center md:text-left">
          <div className="flex md:block justify-center md:justify-start items-center flex-col">
            ...
            <p className="text-base lg:text-xl font-normal mb-2 lg:w-[410px]">
      ...
      {/* steps  */}
      <div className="px-[20px] md:px-[50px] lg:px-[90px] relative z-50">
        {/* title  */}
        <div className="">
          <h1 className="text-xl md:text-3xl lg:text-[50px] font-medium  text-center lg:mb-4">
            Achieve next-level growth
          </h1>
          <h2 className="mb-[150px] text-xl md:text-3xl lg:text-[45px] text-center p-1 lg:p-3 font-bold from-indigo-600 via-purple-500 to-orange-700 bg-gradient-to-r bg-clip-text text-transparent">
            In Just 3 Simple Steps
          </h2>
        </div>
        {/* steps  */}
        <div className="block md:grid grid-cols-3 gap-10 ">
          <div className="shadow shadow-gray-200 rounded-lg p-4 mb-4 text-center md:h-[400px] lg:h-[300px] mb-14 md:mb-0">
          ...
          <div className="shadow shadow-gray-200 rounded-lg p-4 mb-4 text-center md:h-[400px] lg:h-[300px] relative md:-top-16 mb-14 md:mb-0">
            <div className="flex justify-center -top-12 relative">
              <h1 className="text-xl lg:text-[30px] text-white w-12 h-12  lg:w-20 lg:h-20  rounded-lg flex justify-center items-center font-medium text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ">
                2
              </h1>
            </div>
      ...
      <div className="px-[20px] md:px-[50px] lg:px-[90px] ">
        ...
        {/* counter-box  */}
        <div className="block md:grid grid-cols-3 gap-10 lg:gap-[180px] mb-32">
          <div className="bg-black p-5 lg:p-[50px] rounded-md h-40 lg:h-52 mb-5 md:mb-0 text-center md:text-left">
      ...
      <div className="mb-[70px]">
        <h2 className="text-2xl  text-center p-1 lg:p-3 font-bold  from-indigo-800 via-pink-500 to-orange-400 bg-gradient-to-r bg-clip-text text-transparent ">
          Get Started Today
        </h2>
        <h1 className=" text-xl md:text-[30px]  lg:text-[50px] font-medium  text-center mb-4">
          Take the Next Step in Your Social Media Journey
        </h1>
      </div>

      {/* choose  */}
      <div className="px-[20px] md:px-[50px] lg:px-[90px]  flex justify-center mb-8">
      ...
      <div
        className="flex
      justify-center lg:mb-[460px] mb-[200px]"
      >
